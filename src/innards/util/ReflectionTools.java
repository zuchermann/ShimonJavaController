...
public class ReflectionTools
{
	 ...
	 * @see ReflectionTools#getPublicMethodForNameAndParams(Class, String, Class[]) see getPublicMethodForNameAndParams for functions with non 1 params number
	 */
	 ...
	 * @see ReflectionTools#getRunnableForMethodSignature getRunnableForMethodSignature
	 */
