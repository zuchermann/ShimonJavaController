...
public abstract class SimpleParser implements Parser
{
    ...
    protected void requireEndOfFileNow() throws ParseException
    {
        int currentToken = 0;
        try
        {
        ...
        {
            throw new ParseException("At line " + tokenizer.lineno() +
                                            ", the parser expected end-of-file but read: " + tokenizer.toString());
        }
    }

    protected double getNumber() throws ParseException
    {
        int currentToken = 0;
        try
        {
    ...
    protected String getWord() throws ParseException
    {
        int currentToken = 0;
        try
        {
