...
public class LowerResolutionView extends AbstractTopologicalView
{
	...
	{
		iModCount m= (iModCount) getChildren_cache.get(ofThisObject);
		if (m == null)
	...
	public List getParents(Object ofThisObject)
	{
		...
		iModCount m= (iModCount) getParents_cache.get(ofThisObject);
		if (m == null)
	...
	/**@see iTopologicalView.Mutable#sortChildren(Object, Comparator)*/
	public List sortChildren(Object ofThisObject, Comparator c)
	{
		throw new IllegalArgumentException(" not implemented");
	}

	/**@see iTopologicalView#getChild(Object, int)*/
