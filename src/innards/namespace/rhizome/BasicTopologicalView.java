...
public class BasicTopologicalView extends AbstractTopologicalView implements iTopologicalView.Mutable, iChangable, iTopologicalView.iDispatchesTopolgyChange {
	...
	public List listOfRoots() {
		return (List) cachedListOfRoots.data(new iRecompute() {
	...
	public Set everything() {
		return (Set) cachedSetOfEverything.data(new iRecompute() {
			public Object recompute() {
				// scan for things in children with no things in parents
				Set l = new HashSet();
	...
	iModCount cachedListOfRoots = changeable.getModCount(new Serializable() {
	});
	iModCount cachedSetOfEverything = changeable.getModCount(new Serializable() {
	});
	...
	/**
	 * @see marc.rhizome.iMutableHierarchicalView#addChild(Object, Object)
	 */
	...
	/**
	 * @see marc.rhizome.iMutableHierarchicalView#insertChild(Object, int, Object)
	 */
