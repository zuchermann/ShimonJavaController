...
public class MultiLayerTopologicalView extends BasicTopologicalView
{
	...
	{
		this.upDown= upDown;
		((iDispatchesTopolgyChange) upDown).addHandler(new LayerHandler());
	...
	public Iterator orderedLayerIterator()
	{
		...
		sortedList.addAll(((Map) layerSetsCached.data(new iRecompute()
		{
	...
	iModCount layerSetsCached= layerSetsChangeable.getModCount(new Object());
	...
	class LayerHandler implements iHandlesTopologyChange
	{
		/*
