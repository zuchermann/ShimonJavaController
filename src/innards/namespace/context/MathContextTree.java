	...
	extends ContextTree
{
	...
	static public float getFloat(Object key, Combiner comb){return getFloat(key,comb,true);}

	static public float getFloat(Object key, Combiner comb, boolean allNullIsBad)
	{
		boolean never = true;
		Bobj aat = getAt();
		comb.start();
